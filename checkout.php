...
if ($page->is_post()) {
    ...
    $promo_code = $page->post('promo_code');
    ...
    if ($promo_code != '' && strlen($promo_code) != 6) {
        ...
        $promotion = $stm->fetch();
        if (!$promotion) {
            $err['promo'] = 'No such promo code.';
        }
        else {
            $payment -= ($payment * $promotion->rate/100);
        }
    }
    ...
    <div class="jumbotron text-body col-8">
        ...
        <div class="wrapper">
            ...
            <div class="form-group">
                ...
                <input type="text" name="card_number" inputmode="numeric" maxlength="19" pattern="\d{4}-\d{4}-\d{4}-\d{4}" class="col-5 form-control" placeholder="XXXX-XXXX-XXXX-XXXX">
                <?= $html->err_msg($err, 'card_number') ?>
            </div>
            <div class="form-group">
                <label>Credit/Debit Card Expire Date</label>
                <div class="form-inline">
                    <input type="text" name="exp_month" inputmode="numeric" maxlength="2" pattern="\d{2}" class="col-2 form-control" placeholder="mm"> / 
                    <input type="text" name="exp_year" inputmode="numeric" maxlength="2" pattern="\d{2}" class="col-2 form-control" placeholder="yy">
            ...
            <div class="form-group">
                ...
                <input type="text" name="card_cvv" inputmode="numeric" maxlength="3" pattern="\d{3}" class="col-2 form-control" placeholder="XXX">
        ...
        <div class="wrapper form-group">
            ...
            <input type="text" name="promo_code" value="<?= $promo_code ?>" maxlength="6" placeholder="Do you have promo code?" class="form-control">
            <?= $html->err_msg($err, 'promo') ?>
        </div>
