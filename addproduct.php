...
if (!$err) {
    ...
    $stm = $pdo->prepare("
            INSERT INTO product (id, name, description, brand, category, date, price, photo)
            VALUES (?, ?, ?, ?, ?, ?, ?, ?)
        ");
    $stm->execute([$productid, $productname, $description, $brand, $category, $date, $price, $photo]);
...
<form method="post" enctype="multipart/form-data">
    <div class="form">
        <div>
            ...
            <?php $html->error($err, 'productid') ?>
        </div>
        <div>
            <label for="productname">Product Name</label>
            <?php $html->text('productname', $productnama) ?>
            <?php $html->error($err, 'productname') ?>
        </div>
        <div>
